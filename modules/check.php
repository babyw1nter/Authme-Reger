...
// 判断数据库是否已连接
if (!$mysql_con){
	die('<b>Error</b>: ' . mysql_error()); // 连接失败输出错误信息
}
...
if($_GET['action'] == 'sendemkey'){
	...
	$send_email = $_GET['email'];
		...
		$em_text = "您正在进行邮箱验证，请在邮箱验证输入框中输入此次验证码：<br><b><font size='5' color=red>".$_SESSION['em_key']."</font><b><br>如非本人操作，请忽略此邮件，由此给您带来的不便请谅解！<br><br><br><br><br>我的世界<br>2017年06月19日";
